                    ...
                    <div class="prose prose-gray">
                      <ul class="list-disc pl-6 space-y-2">
                        <li><strong>Рекомендовані лінзи</strong>
                          <p class="text-gray-600">Містить: назву, бренд (виробника), індекс заломлення, матеріал, ціну</p></li>
                    ...
                    <div class="prose prose-gray">
                      <ul class="list-disc pl-6 space-y-2">
                        <li><strong>Індекс заломлення лінз</strong>
                          <p class="text-gray-600">Приклади варіантів: 1.5 (стандарт), 1.6 (тонші), 1.67 (ультратонкі), 1.74 (професійні)</p></li>
